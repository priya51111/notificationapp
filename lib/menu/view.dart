...
class _TaskMenuPageState extends State<TaskMenuPage> {
  ...
  onPressed: () {
    if (selectedTask != null && selectedTask!.taskId != null) {
      context.read<TaskBloc>().add(DeleteTaskEvent(taskId: selectedTask?.taskId ?? 'default_value'));
      setState(() {
        isTaskSelected = false;
        selectedTask = null;
      });
    } else {
      // Handle the case where selectedTask or taskId is null
                      ...
                      child: task.isChecked
                          ...
                          : Container(
                              ...
                              decoration: BoxDecoration(
                                color: isExpired ? Colors.red : Color.fromARGB(135, 33, 149, 243),
